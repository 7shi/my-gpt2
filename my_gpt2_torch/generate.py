...
# dependencies = ["torch>=2.0.0", "numpy>=2.4.3", "safetensors>=0.7.0", "regex>=2024.0.0", "packaging"]
# ///
    ...
    for _ in range(n_tokens_to_generate):
        ...
        if temperature > 0:
            ...
            if top_p is not None and 0.0 < top_p < 1.0:
                ...
                cutoff = torch.searchsorted(cumulative_probs, top_p).item() + 1
...
def main():
    parser = argparse.ArgumentParser(
        description="PyTorchによるGPT-2推論エンジン",
