ページ：[1](01_overview.md) | [2](02_tokenizer.md) | [3](03_spiece.md) | [4](04_embedding.md) | [5](05_layer_norm.md) | [6](06_attention.md) | **7** | [8](08_residual.md) | [9](09_output.md) | [10](10_kv_cache.md) | [11](11_architecture.md)
...
class MLPParams:
    def __call__(self, x):
        a = gelu(np.matmul(x, self.w_fc) + self.b_fc)    # 768 → 3072
        return np.matmul(a, self.w_proj) + self.b_proj     # 3072 → 768
```
...
ただし、この出力はそのまま次の層に渡されるのではなく、残差接続（08 参照）によって元のベクトルに「加算」されます。
